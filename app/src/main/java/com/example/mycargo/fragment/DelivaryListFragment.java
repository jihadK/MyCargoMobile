...
import com.example.mycargo.adapter.OrderDeliveryAdapter;
...
public class DelivaryListFragment extends Fragment {
    View view;
    TextView mTitle;
    ...
    public class OrderTask extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected JSONObject doInBackground(Void... params) {
            ...
            try {
                returnjson= SendAndReceiveJSON.downloadUrlAndGetJSONPOST(
                        CallWS.URLMyCargo+"mycargomobile/getOrderDriverDelivery", jsonSet);
                System.out.println(returnjson);
                return returnjson;
            } catch (Exception e) {
                Toast.makeText(context, "Notification : failed order delivery",Toast.LENGTH_LONG);
                return returnjson;
            }
        }
        ...
        protected void onPostExecute(JSONObject returnjson) {
            ...
            mOrderDeliveryAdapter = new OrderDeliveryAdapter(array_order_list);
            mRecyclerView.setAdapter(mOrderDeliveryAdapter);
