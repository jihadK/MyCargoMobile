...
public class DirectionActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        end=new LatLng(112.6653392,-7.2049862);
...
//        });
    ...
    public void Findroutes(LatLng Start)
    {
        if(Start==null) {
            System.out.println("--- error rout");
            Toast.makeText(DirectionActivity.this,"Unable to get location",Toast.LENGTH_LONG).show();
        }
        else
        {
            System.out.println("--- rout : " + Start.latitude  + ";" + Start.longitude + " _ " + end.latitude + ";" + end.longitude);
            ...
            Routing routing = new Routing.Builder()
                    ...
                    .waypoints(Start, end)
                    .key(getString(R.string.google_api_key))  //also define your api key here.
                    .build();
            routing.execute();
        }
    }
